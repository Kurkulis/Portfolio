    ...
    return (
        <div className="home-hero min-vh-100 d-flex align-items-center">
            <Container fluid className="px-3 px-md-4 px-lg-5">
                <Row className="align-items-center justify-content-center g-4 g-lg-5" ref={elementRef}>
                    <Col xs={12} md={6} lg={5} xl={6} className="order-2 order-md-2 order-xl-1 offset-xl-1">
                        <div className={`home-text ${isVisible ? 'animate-in' : ''}`}>
                            <div className="home-greeting badge text-primary px-3 py-2 mb-3 rounded-pill">
                                {homeData.greeting}
                            </div>
                            <h1 className="home-title display-3 fw-bold mb-3 text-primary">
                                {homeData.name}<span className="last-name">{ ' ' + homeData.lastName}</span>
                            </h1>
                            ...
                            <nav className="home-nav mb-4">
                                <div className="d-flex flex-wrap gap-2 justify-content-center justify-content-md-center justify-content-xl-start">
                                    {homeData.navItems.map((item) => (
                                        <button
                                            className={`btn btn-sm ${item.active ? 'btn-primary' : 'btn-outline-primary'} rounded-pill`}
                                            key={item.label}
                            ...
                            {/* CTA Buttons */}
                            {/* <div className="home-cta d-flex flex-column flex-sm-row gap-3 justify-content-center justify-content-lg-start">
                    ...
                    <Col xs={12} md={6} lg={7} xl={5} className="order-1 order-md-1 order-xl-2 d-flex justify-content-center">
