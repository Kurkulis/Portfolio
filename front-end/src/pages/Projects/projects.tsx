        ...
        <Row className="mb-5">
          <Col xs={12}>
            <div className="text-center" ref={elementRef}>
              <h1
                className={`projects-title display-3 fw-bold title-color  mb-3 ${
              ...
              <p
                className={`projects-subtitle h5 mb-4 ${
                  isVisible ? "animate-in animate-delay-1" : ""
                }`}
              >
            ...
            <Col key={index} xs={12} md={6} lg={6}>
              <Card className="project-card h-100 border-0 shadow-sm overflow-hidden">
                ...
                <Card.Body className="d-flex flex-column">
                  <Card.Title className="h5 mb-3 title-color">
                    {project.title}
                  </Card.Title>
