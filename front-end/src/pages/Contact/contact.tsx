        ...
        <Row className="mb-5">
          <Col xs={12}>
            <div className="text-center" ref={elementRef}>
              <h1
                className={`contact-heading display-3 fw-bold title-color mb-3 ${
              ...
              <p
                className={`contact-subheading lead mb-4 ${
                  isVisible ? "animate-in" : ""
                }`}
              >
        ...
        <Row className="g-4 g-lg-5">
          ...
          <Col xs={12} lg={5}>
            <Card className="contact-info-card h-100 border-0 shadow-lg">
              <Card.Body className="p-4 p-md-5">
                <h2 className="h3 mb-4 title-color fw-bold mb-5">
                  ...
                  <div className="d-flex">
                    ...
                    <div className="contact-content flex-grow-1">
                      ...
                      <div className="contact-value">
                        <a
                          href={`mailto:${contactData.left.email.value}`}
                ...
                <div className="contact-block mb-5">
                  <div className="d-flex">
                    ...
                    <div className="contact-content flex-grow-1">
                      ...
                      <div className="contact-value">
                        <a
                          href={`tel:${contactData.left.phone.value}`}
                          className="text-decoration-none"
                        >
          ...
          <Col xs={12} lg={7}>
            <Card className="contact-form-card h-100 border-0 shadow-lg">
              <Card.Body className="p-4 p-md-5">
                <h3 className="h4 mb-5 title-color fw-bold">
                ...
                <Form className="contact-form" onSubmit={handleSubmit}>
                  <Row className="g-4">
                    {contactData.right.fields.map((field, id) => (
                      <Col
                        ...
                        xs={12}
                        md={
                          field.type === "textarea" || field.name === "subject"
                            ? 12
                            : 6
                        }
                      >
                  ...
                  <div className="text-center mt-5">
                    ...
                    >
                      ...
                      <span>
                        {isLoading
                          ? contactData.right.button.working
                          : contactData.right.button.text}
                      </span>
                    </Button>
                  </div>
                </Form>
