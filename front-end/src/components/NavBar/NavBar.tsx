...
const NavBar: React.FC<NavBarProps> = ({ navigationData }) => {
  ...
  return (
    <nav
      className={`navbar navbar-expand-custom navbar-light bg-light fixed-top custom-navbar ${
      ...
      <div className="container-fluid">
        ...
        >
          ...
          <div className="navbar-nav ms-auto d-flex">
            <button
              className="theme-changer-button language-toggle-btn"
              type="button"
              onClick={toggleLanguage}
              title={`Switch to ${
                language === "en" ? "Lithuanian" : "English"
              }`}
